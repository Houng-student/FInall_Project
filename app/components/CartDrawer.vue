      ...
      >
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <span
              class="bg-black text-white text-[10px] font-bold px-2 py-0.5 rounded-full"
            >
        ...
        <div class="max-h-60 overflow-y-auto p-3 space-y-3">
          ...
          >
            ...
            <div
              class="flex items-center gap-1.5 bg-white px-2 py-1 rounded-md border text-xs"
            >
              <button
                @click="cartStore.decreaseQuantity(item.id ?? item.productId)"
                class="text-gray-500 font-bold hover:text-black"
              >
                -
              </button>
        ...
        >
          ...
          <NuxtLink
            to="/checkout"
            @click="closeDrawer()"
            class="block w-full bg-black hover:bg-gray-800 text-white text-xs font-medium py-2.5 rounded-xl transition-all text-center"
          >
            Checkout ➔
          </NuxtLink>
        </div>
